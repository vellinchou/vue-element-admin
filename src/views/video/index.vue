...
export default {
  ...
  //  请求 URL: https://api.nilecom.cn/cloudunicomm/video.do?func=get_room_list
  //  https://api.nilecom.cn/cloudunicomm/video.do?func=doubleRoom
      RTCRoom.httpRequest({
        url: "https://api.nilecom.cn/cloudunicomm/video.do?func=get_im_login_info",
        ...
        success: function(ret) {
          ...
          ret.data.serverDomain = "https://api.nilecom.cn/cloudunicomm/video.do?func=";
